...
class RibbonWidget(QWidget):
    ...
    def set_callbacks(self, main_window):
        ...
        self.buttons['view']['view_x_pos'].clicked.connect(main_window.set_view_x_positive)
        self.buttons['view']['view_x_neg'].clicked.connect(main_window.set_view_x_negative)
        self.buttons['view']['view_y_pos'].clicked.connect(main_window.set_view_y_positive)
        self.buttons['view']['view_y_neg'].clicked.connect(main_window.set_view_y_negative)
        self.buttons['view']['view_z_pos'].clicked.connect(main_window.set_view_z_positive)
        self.buttons['view']['view_z_neg'].clicked.connect(main_window.set_view_z_negative)
        self.buttons['view']['view_iso'].clicked.connect(main_window.set_view_isometric)
